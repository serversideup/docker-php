...
PHP\_BASEDIR\_EXTENSION|                                              Extend the opinionated `open_basedir` setting. (<a href="https://www.php.net/manual/en/ini.core.php#ini.open-basedir">Official Docs</a>)                                              |fpm,<br />fpm-nginx,<br />fpm-apache|none <br/> <br/> 🚨 IMPORTANT: Do not set this environment in production
