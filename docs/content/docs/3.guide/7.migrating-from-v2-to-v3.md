...
[Learn how to install your own PHP extension →](/docs/content/docs/guide/installing-additional-php-extensions)
...
[See the discussion →](https://github.com/serversideup/docker-php/discussions/252)
::
