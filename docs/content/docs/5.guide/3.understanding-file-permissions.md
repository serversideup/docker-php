...
![Traditional PHP File Permissions Configuration](images/docs/permissions-privileged.png){:zoom=false}
...
:u-button{to="https://serversideup.net/open-source/spin/" label="Learn more about Spin" aria-label="Learn more about Spin" size="md" color="primary" variant="outline" trailing-icon="i-lucide-arrow-right" class="font-bold"}