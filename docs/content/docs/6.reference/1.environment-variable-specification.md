...
`PHP_OPEN_BASEDIR`<br />*Default:$WEB_APP_DIRECTORY:/dev/stdout:/tmp*|Limit the files that can be accessed by PHP to the specified directory-tree, including the file itself.|fpm,<br />fpm-nginx,<br />fpm-apache
