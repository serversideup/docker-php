...
| `{{php-version}}` <br />The version of PHP to use. | Latest stable PHP minor version (ie. `8.5`) | `8.4` <br /> `8.3` <br /> `8.2` <br /> (you can also specify the full version number, ie. `8.4.1`) |
