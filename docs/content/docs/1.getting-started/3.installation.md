...
## You've got this 💪
You've successfully created your first PHP app with Docker. Better yet, you've seen the power of serversideup/php where it's easy to change your PHP version and/or variation by changing a single line in your configuration file.
