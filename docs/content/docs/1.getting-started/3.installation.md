...
:u-button{to="/docs/guide/migrating-from-official-php-images" label="Learn how to migrate from the official PHP images" aria-label="Learn how to migrate from the official PHP images" size="md" color="primary" variant="outline"  trailing-icon="i-lucide-arrow-right" class="font-bold"}
...
:u-button{to="/docs/deployment-and-production/development-to-production" label="Learn how to deploy your PHP app from Development to Production" aria-label="Learn how to deploy your PHP app from Development to Production" size="md" color="primary" variant="outline"  trailing-icon="i-lucide-arrow-right" class="font-bold"}